  ...
  return (
    <div>
      ...
      <section className="body w-screen">
        ...
        pois proporciona a cor correta da mídia. Esta extensão consegue proporcionar economia de tinta pois identifica a quantidade exata de pigmento que será usada."></Serviço>
        <Serviço
        ...
        imageUrl={catalogo} title="CATÁLOGO DIGITAL" 
        ...
        ou seja criar ilustrações para jornais, livros e revistas para todo tipo de mídia, impressa e eletrônica."></Serviço>
        <Serviço
        ...
        de acordo com cada modelo e capacidade de impressão."></Serviço>      
      </section>
      <div className="bg-gradient-to-r from-sky-300 to-emerald-200 opacity-90 flex px-[20%] py-4">
        <Buttom locale="bot">Acesse as pastas</Buttom>
      </div>
